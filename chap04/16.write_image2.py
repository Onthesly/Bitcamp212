...
image8 = cv2.imread('./ch04/read_color.jpg', cv2.IMREAD_COLOR)
if image8 is None: raise Exception('영상파일 읽기 에러')             # 영상파일 예외처리
...
cv2.imwrite('./ch04/write_test_16.tif', image16)                # 16비트 행렬 저장
cv2.imwrite('./ch04/write_test_32.tif', image32)                # 32비트 행렬 저장
